    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-subscriptionOrders">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.order.fields.subscription') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-subscriptionOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
