    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-saverTransactions">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($transactions as $key => $transaction)
                            <tr data-entry-id="{{ $transaction->id }}">
                                ...
                                <td>
                                    {{ $transaction->saver->email ?? '' }}
                                </td>
                                <td>
                                    {{ $transaction->saver->phone_1 ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-saverTransactions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
