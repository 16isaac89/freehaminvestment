    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-phonenumberTransactions">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.transaction.fields.phonenumber') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.transaction.fields.biller') }}
                            </th>
                            <th>
                                {{ trans('cruds.transaction.fields.reference') }}
                            </th>
                            <th>
                                {{ trans('cruds.transaction.fields.memo') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-phonenumberTransactions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
