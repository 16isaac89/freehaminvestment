...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="second_name">{{ trans('cruds.user.fields.second_name') }}</label>
                <input class="form-control {{ $errors->has('second_name') ? 'is-invalid' : '' }}" type="text" name="second_name" id="second_name" value="{{ old('second_name', $user->second_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phonenumber') ? 'is-invalid' : '' }}" type="text" name="phonenumber" id="phonenumber" value="{{ old('phonenumber', $user->phonenumber) }}">
